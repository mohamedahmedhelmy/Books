...
namespace Books.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        {
            var item = _unitOfWork.ShoppingCart.GetFirstOrDefault(x => x.Id == cartId);
            _unitOfWork.ShoppingCart.InCrementCount(item, 1);
            _unitOfWork.Save();
        ...
        public IActionResult Minus(int cartId)
        {
            ...
            _unitOfWork.ShoppingCart.DeCrementCount(item, 1);
            _unitOfWork.Save();
            return RedirectToAction(nameof(Index));
        }
